...
COMPONENTS="main/py.storage components/py.pi main/py.main interfaces/REST/py.server tools/py.doc interfaces/NATS/py.client tools/py.CLI components/py.pgp tools/py.doc"
