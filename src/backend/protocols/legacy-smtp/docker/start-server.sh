...
[[ -z ${CALIOPEN_VIRTUAL_TRANSPORT} ]] && echo "unable to find CALIOPEN_VIRTUAL_TRANSPORT environment variable" && exit 1
postconf -e virtual_transport=${CALIOPEN_VIRTUAL_TRANSPORT}
