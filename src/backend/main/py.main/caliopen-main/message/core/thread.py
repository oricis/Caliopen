...
from caliopen-storage.user.core import Contact

from caliopen-storage.message.store import  \
...
from caliopen-storage.message.parameters import Thread as ThreadParam
