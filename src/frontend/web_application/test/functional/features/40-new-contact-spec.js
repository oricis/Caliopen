...
describe('Create new contact', () => {
  ...
  it('New', async () => {
    ...
    await browser.wait(EC.stalenessOf(element(by.cssContainingText('.s-contact__action[disabled]', 'Validate'))), 2000);
    await element(by.cssContainingText('.s-contact__action', 'Validate')).click();
    await browser.wait(EC.stalenessOf($('.m-action-bar__loading .m-spinner')), 1000);
