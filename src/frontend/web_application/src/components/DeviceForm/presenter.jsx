...
const DisplayDevice = ({ device, deviceTypes, deviceIPs, insertDate, lastSeenDate, __ }) => (
  <div>
...
DisplayDevice.propTypes = {
  ...
  deviceIPs: PropTypes.shape({}),
  lastSeenDate: PropTypes.string,
  insertDate: PropTypes.string,
  __: PropTypes.func,
};

const VerifyDevice = ({ device, insertDate, lastSeenDate, __ }) => (
  <Section
...
const DeviceForm = ({ device, __ }) => {
  ...
  const noop = str => str;
  const authorizedDevice = device.signature_key;
