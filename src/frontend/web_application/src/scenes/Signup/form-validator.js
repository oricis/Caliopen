...
export const getLocalizedErrors = i18n => ({
  ...
  [ERR_INVALID_CHARACTER]: i18n._('signup.feedback.username_invalid_characters', { values: { 0: '"@`:;<>[]\\' } }, { defaults: 'The username cannot contain some special characters like {0} and space' }),
