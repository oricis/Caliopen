...
class InterfaceSettings extends PureComponent {
  ...
  initTranslations() {
    ...
    this.i18n = {
      fr_FR: i18n.t`settings.interface.language.options.fr`,
      en_EN: i18n.t`settings.interface.language.options.en`,
      de_DE: i18n.t`settings.interface.language.options.de`,
    };
  }
        ...
        <FormRow>
          <FormColumn size="shrink" bottomSpace >
            <Field
              ...
              name="default_locale"
              label={i18n.t`settings.interface.language.label`}
