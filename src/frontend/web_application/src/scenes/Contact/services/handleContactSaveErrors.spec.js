import { handleContactSaveErrors, CONTACT_UNKNOWN_ERROR, CONTACT_ERROR_ADDRESS_UNICITY_CONSTRAINT } from './handleContactSaveErrors';
        ...
        response: {
          ...
          data: {
            errors: [{
              ...
              code: 6,
              message: '[RESTfacility] PatchContact forbidden : uri <email:contact@foobar.tld> belongs to contact 62844b07-e59f-41e1-b1d6-6dff9dd03710',
              name: '',
            }, {
              code: 422,
              message: 'uri <email:contact@foobar.tld> belongs to contact 62844b07-e59f-41e1-b1d6-6dff9dd03710',
              name: '',
            }],
          },
        },
