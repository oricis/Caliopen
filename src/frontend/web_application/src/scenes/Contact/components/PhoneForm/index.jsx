...
class PhoneForm extends PureComponent {
  ...
  initTranslations() {
    ...
    this.addressTypes = {
      work: i18n.t`contact.phone_type.work`,
      home: i18n.t`contact.phone_type.home`,
      other: i18n.t`contact.phone_type.other`,
    };
  }
          ...
          <FormRow>
            ...
            <FormColumn size="shrink" bottomSpace>
              <Field
                ...
                name="type"
                label={i18n.t`contact.phone_form.type.label`}
                showLabelforSr
                options={typeOptions}
              />
            </FormColumn>
            <FormColumn size="medium" fluid bottomSpace>
              <Field
                ...
                name="number"
                type="tel"
                label={i18n.t`contact.phone_form.number.label`}
                showLabelforSr
                required
              />
            </FormColumn>
