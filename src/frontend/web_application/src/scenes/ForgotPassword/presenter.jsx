...
class ForgotPassword extends Component {
  ...
  handleSigninError = ({ response: { status, data: { errors: globalErrors } } }) => {
    ...
    const localizedErrors = {
      [ERROR_IDENTIFIANTS_MISMATCH]: i18n.t`passwords.form.error.identifiants_mismatch`,
      [ERROR_USER_NOT_FOUND]: i18n.t`passwords.form.error.user_not_found`,
      [STATUS_INVALID_FORM]: i18n.t`passwords.form.error.empty`,
    };
