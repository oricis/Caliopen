...
class Presenter extends Component {
  ...
  render() {
    ...
    const messages = [
      { message_id: '1', date_received: (new Date()).toJSON(), type: 'email', participants: [{ address: 'bender@caliopen.local', type: 'from' }, { address: 'zoidberg@caliopen.local', type: 'cc' }, { address: 'me@caliopen.local', type: 'to' }], body: '<p>It\'s okay, Bender. I like cooking too. You, minion. Lift my arm. AFTER H=\r\nIM! I don\'t know what you did, Fry, but once again, you screwed up! Now all\r\nthe planets are gonna start cracking wise.</p>', subject: "Dr. Zoidberg, that doesn't make sense. But, okay!" },
      { message_id: '2', date_received: (new Date()).toJSON(), type: 'email', participants: [{ address: 'bender@caliopen.local', type: 'to' }, { address: 'zoidberg@caliopen.local', type: 'from' }, { address: 'me@caliopen.local', type: 'to' }], body: '<p>Shut up and take my money! Leela, are you alright?</p>', subject: "Re: Dr. Zoidberg, that doesn't make sense. But, okay!" },
